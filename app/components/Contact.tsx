...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "064c935a-1886-40de-9380-e194d104d217");
    ...
    return (
        <motion.div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90% auto]'
            initial={{ opacity: 0 }}
            ...
            <motion.form onSubmit={onSubmit} className='max-w-2xl mx-auto'
                ...
                <motion.textarea
                    ...
                    transition={{
                        delay: 1.3,
                        duration: 0.6
                    }} name="message" rows={6} id="" placeholder='Enter your message' required
                ...
                text-white rounded-full mx-auto hover:bg-black duration-500'>
                    Submit now <Image src={assets.right_arrow_white} alt='arrow-white' className='w-4'></Image>
                </motion.button>
                <p className='mt-5'>
                    {result}
                </p>
